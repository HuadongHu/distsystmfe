...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f302b022c1ea6824fcf8e8e1db309d9cd9a02a959e82c03f2e2baa484e35c00c.js',function(){input.required=false;search();});}
