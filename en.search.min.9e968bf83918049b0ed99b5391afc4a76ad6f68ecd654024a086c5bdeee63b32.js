...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9b50424f9d172e2cfee7a0155381e0aac789f8ef9395df2ebfc088843218e5bc.js',function(){input.required=false;search();});}
